  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        data-chart={chartId}
        className={cn(
          "flex aspect-video justify-center text-xs [&_.recharts-cartesian-axis-tick_text]:fill-neutral-500 [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-neutral-200/80 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-neutral-300 [&_.recharts-layer]:outline-none [&_.recharts-sector]:outline-none [&_.recharts-surface]:outline-none",
          className
        )}
        {...props}
      >
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        'grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-stone-200/80 bg-white px-2.5 py-1.5 text-xs shadow-lg',
        className
      )}
    >
      ...
      {payload.map((item) => {
        ...
        return (
          <div
            ...
            className="flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3 [&>svg]:text-neutral-500"
          >
