...
const GEO_POINTS: Array<{ key: string; aliases: string[]; lat: number; lng: number }> = [
  ...
  { key: 'sunshine coast', aliases: ['sunshine coast', 'sunshine coast qld', 'maroochydore', 'noosa'], lat: -26.65, lng: 153.0667 },
  ...
  { key: 'wollongong', aliases: ['wollongong', 'wollongong nsw'], lat: -34.4278, lng: 150.8931 },
  { key: 'geelong', aliases: ['geelong', 'geelong vic'], lat: -38.1499, lng: 144.3617 },
  { key: 'hobart', aliases: ['hobart', 'hobart tas'], lat: -42.8821, lng: 147.3272 },
  { key: 'darwin', aliases: ['darwin', 'darwin nt'], lat: -12.4634, lng: 130.8456 },
  { key: 'cairns', aliases: ['cairns', 'cairns qld'], lat: -16.9186, lng: 145.7781 },
  { key: 'townsville', aliases: ['townsville', 'townsville qld'], lat: -19.259, lng: 146.8169 },
  { key: 'toowoomba', aliases: ['toowoomba', 'toowoomba qld'], lat: -27.5598, lng: 151.9507 },
...
export const TARGETING_MAP_DEMO_ROWS: TargetingMapLeadRow[] = [
  ...
  ...Array.from({ length: 22 }, () => ({ city: 'Perth', state: 'WA', outbound_status: 'contacted' })),
  ...Array.from({ length: 7 }, () => ({ city: 'Perth', state: 'WA', outbound_status: 'replied' })),
  ...Array.from({ length: 5 }, () => ({ city: 'Perth', state: 'WA', outbound_status: 'interested' })),
  ...Array.from({ length: 3 }, () => ({ city: 'Perth', state: 'WA', outbound_status: 'booked' })),
  ...Array.from({ length: 18 }, () => ({ city: 'Adelaide', state: 'SA', outbound_status: 'contacted' })),
  ...Array.from({ length: 4 }, () => ({ city: 'Adelaide', state: 'SA', outbound_status: 'replied' })),
  ...Array.from({ length: 2 }, () => ({ city: 'Adelaide', state: 'SA', outbound_status: 'booked' })),
  ...Array.from({ length: 12 }, () => ({ city: 'Gold Coast', state: 'QLD', outbound_status: 'contacted' })),
  ...Array.from({ length: 3 }, () => ({ city: 'Gold Coast', state: 'QLD', outbound_status: 'interested' })),
  ...Array.from({ length: 10 }, () => ({ city: 'Newcastle', state: 'NSW', outbound_status: 'contacted' })),
  ...Array.from({ length: 1 }, () => ({ city: 'Newcastle', state: 'NSW', outbound_status: 'replied' })),
  ...Array.from({ length: 8 }, () => ({ city: 'Cairns', state: 'QLD', outbound_status: 'contacted' })),
