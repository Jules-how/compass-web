/** Leads vs Prospects segmentation for the operator lead list. */

export type LeadBucket = 'leads' | 'prospects'
...
export function isLeadBucket(value: string | null | undefined): value is LeadBucket {
  return value === 'leads' || value === 'prospects'
}

export function parseLeadBucket(value: string | null | undefined): LeadBucket {
  return value === 'prospects' ? 'prospects' : 'leads'
}
