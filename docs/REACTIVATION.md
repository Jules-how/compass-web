...
| Migration | Tables |
| --- | --- |
| `0071_compass_reactivation_lists.sql` | `compass_reactivation_lists`, `compass_reactivation_contacts` |
| `0072_compass_reactivation_messages.sql` | `compass_reactivation_messages` |
