...
test('source pins the morning constants', () => {
  ...
  const home = readFileSync(resolve(root, 'src/components/home/MorningWavePanel.tsx'), 'utf8')
  assert.match(home, /Accept brief/)
  assert.match(home, /Highest leverage/)
  assert.match(home, /Open chunk/)
  assert.match(home, /onOpenChunk/)
