...
test('wave 3 wiring files exist', () => {
  ...
  assert.match(read('supabase/migrations/0067_compass_evidence_events.sql'), /compass_evidence_events/)
  assert.match(read('supabase/migrations/0068_pipeline_spine.sql'), /pipeline_stage/)
})
