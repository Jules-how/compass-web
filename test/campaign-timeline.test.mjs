...
test('campaign planner files and migration are wired', () => {
  ...
  assert.match(planner, /initialView/)
  assert.match(planner, /statusFilter === 'open'/)
  ...
  assert.match(calendar, /nextOpenGoLiveAt/)
  assert.match(calendar, /slotFromGridPoint/)
  assert.match(calendar, /dayFromMonthGridPoint/)
  ...
  assert.match(calendarView, /onMoveCampaign/)
  assert.match(calendarView, /cursor-grab/)
  assert.match(calendarView, /onCursorChange/)
  assert.match(calendarView, /slotFromGridPoint/)
