...
test('migrations 0060-0062 only add deal terms, qbo docs, and spend cache', () => {
  const m60 = read('supabase/migrations/0060_compass_client_deal_terms.sql')
  const m61 = read('supabase/migrations/0061_compass_qbo_docs.sql')
  const m62 = read('supabase/migrations/0062_compass_qbo_doc_meta.sql')
