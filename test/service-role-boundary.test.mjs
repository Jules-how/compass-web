...
test('service-role route inventory remains explicit', () => {
  ...
  assert.deepEqual(serviceRoleRoutes, [
    ...
    'api/agent/crm/capabilities/route.ts',
    'api/agent/crm/collections/route.ts',
    ...
    'api/agent/outbound/pipeline/copy-control/route.ts',
    ...
    'api/operator/outbound/pipeline/copy-control/route.ts',
